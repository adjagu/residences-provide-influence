-------------------------------------------------------------------------------
Explorer Shelters Provide Influence
-------------------------------------------------------------------------------

Explorer shelters now provide influence. Each explorer shelter will provide
influence equal to the amount that <InfluenceAmount> is set to.

Explorers do not provide influence.
Explorer shelters provide influence.

To change the amount of influence explorer shelters provide alter
...
Copy "[Gameplay] Explorer Shelters Provide Influence" into Anno 1800's
mods directory.
...
[Gameplay] Explorer Shelters Provide Influence
...
By default this modification enables each explorer shelter to produce one (1)
...
If you would like each explorer shelter to produce one hundred (100)
