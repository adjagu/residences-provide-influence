-------------------------------------------------------------------------------
Artisan Residences Provide Influence
-------------------------------------------------------------------------------

Artisan residences now provide influence. Each artisan residence will provide
influence equal to the amount that <InfluenceAmount> is set to.

Artisans do not provide influence.
Artisan residences provide influence.

To change the amount of influence artisan residences provide alter
...
Copy "[Gameplay] Artisan Residences Provide Influence" into Anno 1800's
mods directory.
...
[Gameplay] Artisan Residences Provide Influence
...
By default this modification enables each artisan residence to produce
...
<ModOps>
  ...
  <ModOp GUID="1010345" Path="/Values/InfluenceSource" Type="merge">
    <InfluenceAmount>3</InfluenceAmount>
...
If you would like each artisan residence to produce one hundred (100)
