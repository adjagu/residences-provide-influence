-------------------------------------------------------------------------------
Artista Residences Provide Influence
-------------------------------------------------------------------------------

Artista residences now provide influence. Each artista residence will provide
influence equal to the amount that <InfluenceAmount> is set to.

Artistas do not provide influence.
Artista residences provide influence.

To change the amount of influence artista residences provide alter
...
Copy "[Gameplay] Artista Residences Provide Influence" into Anno 1800's
mods directory.
...
[Gameplay] Artista Residences Provide Influence
...
<ModOps>
  ...
  <ModOp GUID="5405" Path="/Values/InfluenceSource" Type="merge">
...
If you would like each artista residence to produce one hundred (100)
