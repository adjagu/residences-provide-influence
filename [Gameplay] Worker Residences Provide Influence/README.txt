-------------------------------------------------------------------------------
Worker Residences Provide Influence
-------------------------------------------------------------------------------

Worker residences now provide influence. Each worker residence will provide
influence equal to the amount that <InfluenceAmount> is set to.

Workers do not provide influence.
Worker residences provide influence.

To change the amount of influence worker residences provide alter
...
Copy "[Gameplay] Worker Residences Provide Influence" into Anno 1800's
mods directory.
...
[Gameplay] Worker Residences Provide Influence
...
By default this modification enables each worker residence to produce
...
<ModOps>
  ...
  <ModOp GUID="1010344" Path="/Values/InfluenceSource" Type="add">
...
If you would like each worker residence to produce one hundred (100)
