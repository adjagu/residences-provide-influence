-------------------------------------------------------------------------------
Farmer Residences Provide Influence
-------------------------------------------------------------------------------

Farmer residences now provide influence. Each farmer residence will provide
influence equal to the amount that <InfluenceAmount> is set to.

Farmers do not provide influence.
Farmer residences provide influence.

To change the amount of influence farmer residences provide alter
...
Copy "[Gameplay] Farmer Residences Provide Influence" into Anno 1800's
mods directory.
...
[Gameplay] Farmer Residences Provide Influence
...
By default this modification enables each farmer residence to produce one (1)
influence. This is shown in the following code:
...
<ModOps>
  ...
  <ModOp GUID="1010343" Path="/Values/InfluenceSource" Type="merge">
...
If you would like each farmer residence to produce one hundred (100) influence
each you could use the following code:
