-------------------------------------------------------------------------------
Shepherd Residences Provide Influence
-------------------------------------------------------------------------------

Shepherd residences now provide influence. Each shepherd residence will provide
influence equal to the amount that <InfluenceAmount> is set to.

Shepherds do not provide influence.
Shepherd residences provide influence.

To change the amount of influence shepherd residences provide alter
...
Copy "[Gameplay] Shepherd Residences Provide Influence" into Anno 1800's
mods directory.
...
[Gameplay] Shepherd Residences Provide Influence
...
By default this modification enables each shepherd residence to produce
...
<ModOps>
  ...
  <ModOp GUID="114436" Path="/Values/InfluenceSource" Type="merge">
