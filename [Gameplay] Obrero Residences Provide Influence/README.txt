-------------------------------------------------------------------------------
Obrero Residences Provide Influence
-------------------------------------------------------------------------------

Obrero residences now provide influence. Each obrero residence will provide
influence equal to the amount that <InfluenceAmount> is set to.

Obreros do not provide influence.
Obrero residences provide influence.

To change the amount of influence obrero residences provide alter
...
Copy "[Gameplay] Obrero Residences Provide Influence" into Anno 1800's
mods directory.
...
[Gameplay] Obrero Residences Provide Influence
...
By default this modification enables each obrero residence to produce
...
<ModOps>
  ...
  <ModOp GUID="101255" Path="/Values/InfluenceSource" Type="merge">
...
If you would like each obrero residence to produce one hundred (100)
